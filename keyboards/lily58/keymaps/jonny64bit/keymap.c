 ...
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |LALT  |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |Delt  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI |LOWER |RAISE | /Space  /       \Enter \  |BSPC  |MOVEMENT| EXTRA |
 *                   |      |      |      |/       /         \      \ |      |        |       |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LGUI, OSL(_LOWER), OSL(_RAISE), LT(_MOVEMENT, KC_SPACE), SFT_T(KC_ENT), CTL_T(KC_BSPC), MO(_MOVEMENT), OSL(_EXTRA)
),
